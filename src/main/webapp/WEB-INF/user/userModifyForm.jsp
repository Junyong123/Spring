   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form id="frm" action="${pageContext.request.contextPath}/user/userModifyForm" method="post"
...
//          $("#pass").val("${userVO.pass}");
         $("img").attr("src", "${pageContext.request.contextPath}/user/profileImg?userId=${userVO.userId}");
      }
