            	...
            	<nav style="text-align:center;"> 
				  <ul class="pagination">
            		...
            		<c:choose>
            			...
            			<c:otherwise>
            				<li>
	    					<a href="${ pageContext.servletContext.contextPath}/lprod/lprodPagingList" aria-label="Next">
				        		<span aria-hidden="true">&raquo;</span>
				      		</a>
				      	</li>
            			</c:otherwise>
...
// 				$("#frm").attr("action", "/prodList"); //속성바꿀때 사용
	...
	<form id ="frm" action="<%=request.getContextPath()%>/lprod/prodList" method="get">
